const lang = {
  ...
  'AgentMetrics.Title': 'Andropay CRM',
  ...
  'Tasks.Caption': 'Tasks assigned to you in Andropay CRM.',
  'Tasks.ShowDone': 'Show completed',
  'Tasks.Empty': 'No open tasks assigned to you.',
  'Tasks.NoProjects': 'You are not on any project yet.',
  'Tasks.FillFields': 'Pick a project and enter a title.',
  'Tasks.Created': 'Task created',
  'Tasks.CreateFailed': 'Could not create the task.',
  'Tasks.TimeLogged': 'Time logged',
  'Tasks.TimeFailed': 'Could not log time.',
  'Tasks.StatusFailed': 'Could not update the task.',
  'Tasks.NotConnected': 'Connect to Andropay first (Settings → AndroPay CRM).',
  'Tasks.PickProject': 'Which project?',
  'Tasks.PickProjectFor': 'Create "%1$s" in:',
  'Tasks.CreateFromMessage': 'Create task from message',
  'Tasks.Details': 'Details (optional)',
  'Tasks.AssignTo': 'Assign to',
  'Tasks.ForCustomer': 'For customer:',
  'Tasks.NoMembers': 'Nobody else is on this project.',
  'Tasks.OpenChat': 'Open chat',
  'Tasks.CustomerGone': 'That chat is no longer available.',
  'Tasks.ForSomeoneElse': 'Assign to someone else…',
  'Tasks.ShowDelegated': 'Show tasks I delegated',
  ...
  'Crm.SeenFirstBy': 'Seen first by %1$s',
  'Crm.ReadOnly.Title': 'Read-only access',
  ...
  'Connection.Relay.Toggle': 'Connect through relay',
  'Connection.Relay.Host': 'Relay host (empty = this site)',
  'Connection.Relay.Caption': 'Sends all Telegram traffic through a relay server instead of connecting to Telegram directly. Use it when Telegram is blocked on your network but this site is reachable. Leave the host empty to relay through the server this app is loaded from. Takes effect immediately, no reload needed.',
  ...
  'Crm.Sensitive.Approve': 'Approve',
  'Crm.Sensitive.ReasonTitle': 'View sensitive data',
  'Crm.Sensitive.ReasonDescription': 'Enter a reason for viewing this data. It will be logged.',
  'Crm.Sensitive.ReasonDescriptionApproval': 'Enter a reason for viewing this data. A manager will review it before approving.',
  'Crm.Sensitive.ReasonLabel': 'Reason to view',
  'Crm.Sensitive.RevealButton': 'View',
  'Crm.Sensitive.RequestButton': 'Send request',
  'Crm.Note.PanelTitle': 'Internal notes',
  'Crm.Note.MenuButton': 'Internal notes',
  'Crm.Note.Add': 'Add note',
  'Crm.Note.Placeholder': 'Write an internal note for other agents…',
  'Crm.Note.None': 'No internal notes yet',
  'Crm.Note.TabName': 'Notes',
  'Crm.Note.Count': {
    'one_value': '%d note',
    'other_value': '%d notes'
  },
  'Crm.Note.Empty': 'Type the note text after /note',
  'Crm.Note.NoTicket': 'No ticket to attach the note to',
  'Crm.Note.AddFailed': 'Failed to add the note, please try again',
  'Crm.Note.ShareAllDepartments': 'Visible to all departments',
  'Crm.Note.SharedBadge': 'All departments',
  'Crm.Note.FromDepartment': 'From %1$s',
  'Crm.Note.Edited': 'edited',
  'Crm.Note.DeleteTitle': 'Delete note',
  'Crm.Note.DeleteConfirm': 'Delete this internal note? Other agents will no longer see it.',
  ...
  'Crm.ProfileForm.MenuButton': 'Andropay profile',
  'Crm.ProfileForm.Title': 'Andropay profile',
  'Crm.ProfileForm.Intro': 'Send the customer a form link to fill in their identity, contact, bank account and documents. The link works for 24 hours and goes into your message box, so you can check it before sending.',
  'Crm.ProfileForm.IntroComplete': 'This customer\u2019s profile is already complete. Only send a new form if their details have changed.',
  'Crm.ProfileForm.AndropayOrg': 'andropay.org',
  'Crm.ProfileForm.CrmForm': 'Profile form',
  'Crm.ProfileForm.NotChecked': 'Could not check',
  'Crm.ProfileForm.NotMember': 'Not registered',
  'Crm.ProfileForm.Complete': 'Complete',
  'Crm.ProfileForm.Incomplete': 'Incomplete',
  'Crm.ProfileForm.Missing': 'Missing:',
  'Crm.ProfileForm.NeverSent': 'Never sent',
  'Crm.ProfileForm.ExpiresAt': 'Link works until %s',
  'Crm.ProfileForm.SubmittedAt': 'Submitted %s',
  'Crm.ProfileForm.Send': 'Create form link',
  'Crm.ProfileForm.SendNew': 'Send a new link',
  'Crm.ProfileForm.SendAnyway': 'Send anyway',
  'Crm.ProfileForm.Inserted': 'Form link added to your message',
  'Crm.ProfileForm.Failed': 'Could not create the link, please try again',
  'Crm.ProfileForm.Loading': 'Checking\u2026',
  'Crm.ProfileForm.LoadFailed': 'Could not reach the CRM',
  'Crm.ProfileForm.NoCustomer': 'There is no CRM customer for this chat yet.',
  'Crm.Contract.PanelTitle': 'Contracts',
  'Crm.Contract.TabName': 'Contracts',
  'Crm.Contract.MenuButton': 'Contracts',
  'Crm.Contract.Count': {
    'one_value': '%d contract',
    'other_value': '%d contracts'
  },
  'Crm.Contract.CountActive': {
    'one_value': '%d active',
    'other_value': '%d active'
  },
  'Crm.Contract.CountAwaiting': {
    'one_value': '%d awaiting signature',
    'other_value': '%d awaiting signature'
  },
  'Crm.Contract.CountExpiring': {
    'one_value': '%d expiring soon',
    'other_value': '%d expiring soon'
  },
  'Crm.Contract.Loading': 'Loading contracts\u2026',
  'Crm.Contract.None': 'No contracts yet',
  'Crm.Contract.NoAccount': 'This customer has no contracts account',
  'Crm.Contract.Disabled': 'Contracts are not connected',
  'Crm.Contract.NoExpiry': 'no end date',
  'Crm.Contract.AwaitingSignature': 'Awaiting their signature',
  'Crm.Contract.OpenPdf': 'Open PDF',
  'Crm.Contract.Opening': 'Opening\u2026',
  'Crm.AiDraft.Tooltip': 'Draft a reply with AI',
  'Crm.AiDraft.NoPipeline': 'No AI assistant is set up for this department',
  'Crm.AiDraft.NoMessage': 'Nothing from the customer to answer yet',
  'Crm.AiDraft.FilteredOut': 'The assistant left this one for you to answer',
  'Crm.AiDraft.Empty': 'The assistant had nothing to suggest here',
  'Crm.AiDraft.Failed': 'Could not draft a reply, please try again',
  'Crm.AiDraft.RateLimited': 'Too many drafts in a row — wait a moment',
  'Crm.AiDraft.BudgetExceeded': 'The daily AI budget is used up — ask an admin to raise it',
  ...
  'Stories.Composer.NewStory': 'New Story',
  'Stories.Composer.AddStory': 'Add Story',
  'Stories.Composer.Title': 'New Story',
  'Stories.Composer.Post': 'Post Story',
  'Stories.Composer.Posting': 'Posting… %1$d%',
  'Stories.Composer.Posted': 'Story posted.',
  'Stories.Composer.CaptionPlaceholder': 'Add a caption...',
  'Stories.Composer.Privacy': 'Who can see this story',
  'Stories.Composer.Privacy.Everyone': 'Everyone',
  'Stories.Composer.Privacy.Contacts': 'My Contacts',
  'Stories.Composer.Privacy.CloseFriends': 'Close Friends',
  'Stories.Composer.Period': 'Keep for',
  'Stories.Composer.KeepOnProfile': 'Keep on my profile after it expires',
  'Stories.Composer.KeepOnChannel': 'Keep on the channel page after it expires',
  'Stories.Composer.UnsupportedFile': 'Choose a photo or a video to post as a story.',
  'Stories.Composer.VideoTooLong': 'Story videos can be up to %1$d seconds long.',
  ...
  'Checkout.WebConfirmation.NotLoading': 'Payment page blank or not loading? It may not be allowed to open here.',
  'Checkout.WebConfirmation.OpenedInNewTab': 'Finish paying in the new tab, then come back here.',
  'Checkout.WebConfirmation.OpenInNewTab': 'Open in a New Tab',
  'Checkout.WebConfirmation.Done': 'I\'ve Finished Paying',
